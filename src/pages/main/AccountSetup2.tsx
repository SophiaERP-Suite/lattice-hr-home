...
//   const getCategory = async (jobSectorId: number) => {
//     const response = getJobCategories(jobSectorId);

//     if (!response) {
//       toast.error("There are no categories on this sector");
//       return;
//     }
...
//       window.open(
//         `http://localhost:5173/one/lhr_cdt/auth-bridge?token=${token}`,
//       );
//     } catch (error) {
