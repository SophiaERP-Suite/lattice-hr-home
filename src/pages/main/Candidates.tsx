    ...
    <>
            ...
            <div className="col-lg-7 m-auto">
              <div className="heading1 text-center space-margin60">
                ...
                <p data-aos="zoom-in" data-aos-duration="1100">
                  We bridge the gap between employers and professionals, making
                  it easy to find the right fit for every role.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              >
                ...
                <div className="works8-boxarea">
                  <a href="projects-single.html">Browse Available Jobs</a>
                  <div className="space16"></div>
                  <p>
                    Explore verified openings from trusted employers across
                    multiple industries.
                  </p>
                  <h5>02</h5>
                </div>
              ...
              >
                ...
                <div className="works8-boxarea">
                  <a href="projects-single.html">
                    Get Hired and Start Your Journey
                  </a>
                  <div className="space16"></div>
                  <p>
                    Receive responses from employers and take the next step in
                    your career.
                  </p>
                  <h5>04</h5>
                </div>
            ...
            <div className="col-lg-6">
              ...
              >
                <div className="works8-boxarea">
                  <a href="projects-single.html">
                    Apply for Your Preferred Roles
                  </a>
                  <div className="space16"></div>
                  <p>
      ...
      <div className="benefit1 sp1">
        <div className="container">
          <div className="row">
            <div className="col-lg-7 m-auto">
              <div className="heading1 text-center space-margin60">
                ...
                <div className="space16"></div>
                <p data-aos="zoom-in" data-aos-duration="1100">
                  We go beyond job listings — our platform connects you with
                  real opportunities, personalized support, and the tools to
                  grow your career.
                </p>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="benefit-boxes-area">
                  ...
                  >
                    ...
                    >
                      <span className="button-content">
                        ...
                        <span className="text">
                          <span className="title">Verified Opportunities</span>
                          <span className="pera">
                            Every job is screened to ensure it’s genuine, giving
                            you confidence and security in your search.
                          </span>
                        </span>
                      </span>
                    </button>
                    ...
                    >
                      <span className="button-content">
                        ...
                        <span className="text">
                          ...
                          <span className="pera">
                            Explore jobs across healthcare, tech, education,
                            finance, and more.
                          </span>
                        </span>
                      </span>
                    ...
                    >
                      <span className="button-content">
                        ...
                        <span className="text">
                          ...
                          <span className="pera">
                            Find, apply, and track your job applications all in
                            one place.
                          </span>
                        </span>
                      </span>
                    ...
                    >
                      <span className="button-content">
                        ...
                        <span className="text">
                          ...
                          <span className="pera">
                            Connect with reputable companies across various
                            industries looking for skilled professionals like
                            you.
                          </span>
                        </span>
                      </span>
            ...
            <div className="col-lg-6">
              <div className="benefit-images-area">
                ...
                <div className="accordion" id="accordionExample">
                  ...
                  >
                    <h2 className="accordion-header">
                      ...
                      >
                        How does this platform help job seekers?
                      </button>
                    </h2>
                    <div
                      id="collapseOne"
                    ...
                    >
                      <div className="accordion-body">
                        <p>
                          We connect healthcare professionals with verified
                          hospitals, clinics, and organizations offering genuine
                          job opportunities tailored to their skills and
                          experience.
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    <h2 className="accordion-header">
                      ...
                      >
                        What types of healthcare roles are available?
                      </button>
                    </h2>
                    <div
                      id="collapseTwo"
                    ...
                    >
                      <div className="accordion-body">
                        <p>
                          You’ll find opportunities across various fields —
                          including nursing, medicine, pharmacy, laboratory
                          science, radiology, and administrative healthcare
                          roles.
                        </p>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    >
                      <div className="accordion-body">
                        <p>
                          Yes. You can edit your information, upload new
                          certifications, and update your experience anytime to
                  ...
                  >
                    ...
                    >
                      <div className="accordion-body">
                        <p>
                          Simply create an account, complete your professional
                          profile, and start browsing verified healthcare jobs
