...
const Footer = () => {
  ...
  return (
    <div
      className={`vl-footer2-section-area  ${
        secondFooterPages.includes(pagePath) ? "second-footer" : ""
      }`}
    >
      <div className="container">
          ...
          <div className="col-lg-3 col-md-6">
            <div className="footer-logo-area">
              ...
              <p>
                ...
                strengthen teams and enhance workplace performance — with a
                focus on people, growth, and quality results.
              </p>
        ...
        <div className="col-lg-12">
          <div className="copyright-area">
            <a href="#">Copyright @2025 Lattice HR. All Rights Reserved</a>
            <ul>
              <li>
